...
@section('title', 'Login | Layanan Pengaduan SMK Telkom Jakarta')
@section('content')
            ...
            <div class="flex flex-col items-center md:flex-row">
                ...
                <div class="w-full mt-10 md:mt-0 md:w-2/5">
                    <div
                        ...
                        <h3 class="mb-6 text-2xl font-medium text-center">Login Pengaduan <br> <strong>SMK Telkom
                                Jakarta</strong>
                        </h3>
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-5">Selamat Datang di Sistem Pengaduan Sekolah <strong>SMK Telkom Jakarta</strong></p>
