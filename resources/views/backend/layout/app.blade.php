            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p><?= date('Y') ?> &copy; Pengaduan Sekolah | SMK Telkom Jakarta</p>
                    </div>
                    <div class="float-end">
                        <p>Dashboard Theme<span class="text-danger"></span>
                    </div>
                </div>
            </footer>
        </div>
